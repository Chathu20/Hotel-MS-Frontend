    ...
    <>
      <div className="relative w-full h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center space-y-10 h-full bg-black bg-opacity-50">
          {/* Booking Section */}
          <div className="mt-[1800px] flex flex-col lg:flex-row justify-around items-center w-[80%] lg:w-[800px] h-auto lg:h-[120px] rounded-xl bg-gradient-to-r from-c1 via-c2 to-c3 p-4 shadow-lg">
